...
make: driver.cpp busmode.cpp weathermode.cpp mode.cpp api.cpp
	g++ -std=c++14 -ICimg/ -Irpi-rgb-led-matrix/include -I/opt/homebrew/opt/curlpp/include -I/opt/homebrew/opt/opencv/include/opencv4 -Ijson/include -Dcimg_display=0 -Wall -O3 -g -Wextra -Wno-unused-parameter -c driver.cpp -c busmode.cpp -c weathermode.cpp -c mode.cpp -c api.cpp
